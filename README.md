## Open Source Ngin Mining Pool

### Features

* Support for Stratum mining
* Detailed block stats with luck percentage and full reward
* Failover ngind instances: ngind high availability built in
...
First install  [ngind](https://github.com/NginProject/ngind/releases).

Clone & compile:

    git clone https://github.com/NginProject/ngPool.git
    cd ngPool
    make
...
```javascript
{
  ...
  // Check health of each ngind node in this interval
  "upstreamCheckInterval": "5s",

  /* List of ngind nodes to poll for new jobs. Pool will try to get work from
  ...
  */
  ...
  "unlocker": {
    ...
    "interval": "10m",
    // ngind instance node rpc endpoint for unlocking blocks
    "daemon": "http://127.0.0.1:52521",
    // Rise error if can't reach ngind in this amount of time
    "timeout": "10s"
  },
  ...
  "payouts": {
    ...
    "interval": "12h",
    // ngind instance node rpc endpoint for payouts processing
    "daemon": "http://127.0.0.1:52521",
    // Rise error if can't reach ngind in this amount of time
    "timeout": "10s",
    // Address with pool balance
    "address": "0x0",
    // Let ngind to determine gas and gasPrice
    "autoGas": true,
