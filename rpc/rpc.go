...
func (r *RPCClient) GetWork() ([]string, error) {
	rpcResp, err := r.doPost(r.Url, "ngin_getWork", []string{})
	if err != nil {
		return nil, err
	}
	var reply []string
...
func (r *RPCClient) GetPendingBlock() (*GetBlockReplyPart, error) {
	rpcResp, err := r.doPost(r.Url, "ngin_getBlockByNumber", []interface{}{"pending", false})
	if err != nil {
		return nil, err
	}
...
func (r *RPCClient) GetBlockByHeight(height int64) (*GetBlockReply, error) {
	...
	return r.getBlockBy("ngin_getBlockByNumber", params)
}

func (r *RPCClient) GetBlockByHash(hash string) (*GetBlockReply, error) {
	params := []interface{}{hash, true}
	return r.getBlockBy("ngin_getBlockByHash", params)
}
...
func (r *RPCClient) GetUncleByBlockNumberAndIndex(height int64, index int) (*GetBlockReply, error) {
	...
	return r.getBlockBy("ngin_getUncleByBlockNumberAndIndex", params)
}
...
func (r *RPCClient) GetTxReceipt(hash string) (*TxReceipt, error) {
	rpcResp, err := r.doPost(r.Url, "ngin_getTransactionReceipt", []string{hash})
	if err != nil {
		return nil, err
	}
	if rpcResp.Result != nil {
...
func (r *RPCClient) SubmitBlock(params []string) (bool, error) {
	rpcResp, err := r.doPost(r.Url, "ngin_submitWork", params[:2])
	if err != nil {
		return false, err
	}
	var reply bool
...
func (r *RPCClient) GetBalance(address string) (*big.Int, error) {
	rpcResp, err := r.doPost(r.Url, "ngin_getBalance", []string{address, "latest"})
	if err != nil {
		return nil, err
	}
	var reply string
...
func (r *RPCClient) Sign(from string, s string) (string, error) {
	rpcResp, err := r.doPost(r.Url, "ngin_sign", []string{from, s})
	var reply string
	if err != nil {
		return reply, err
	}
...
func (r *RPCClient) SendTransaction(from, to, gas, gasPrice, value string, autoGas bool) (string, error) {
	...
	rpcResp, err := r.doPost(r.Url, "ngin_sendTransaction", []interface{}{params})
	var reply string
	if err != nil {
		return reply, err
	}
